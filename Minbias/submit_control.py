...
#InputDir = "/data1/DATA/TTI_Minbias/Ntuple/Central_Full_Minbias_withL1TkEleIso"
#InputDir = "/data1/DATA/TTI_Minbias/Ntuple/Central_Full_Minbias_withL1TkEleIso_newHoverEcut"
#InputDir = "/data1/DATA/TTI_Minbias/Ntuple/Ntuple_107327"
#InputDir = "dcap://cluster142.knu.ac.kr//pnfs/knu.ac.kr/data/cms/store/user/jhkim/PhaseII_Minbias_CMSSW620_SLHC12_patch1"
#InputDir = "/pnfs/knu.ac.kr/data/cms/store/user/jhkim/PhaseII_Minbias_CMSSW620_SLHC12_patch1"
#InputDir = "/u/user/moon/L1Pixel_KNU/MC/Minbias_cmssw620"
#InputDir = "/pnfs/knu.ac.kr/data/cms/store/user/lhakseon/Minbias_cmssw620"
#InputDir = "/xrootd/store/user/jongho/PhaseII_SE140_CMSSW620_SLHC12_patch1/"
InputDir = "/xrootd/store/user/jongho/Minbias_cmssw620/"

textfile = open("./inputlist_work.txt",'w')
for i in range(1,151):
    txt = "root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/jongho/Minbias_cmssw620/Minbias_official_samples140PU_%d.root \n" % i
    textfile.write(txt)
        
textfile.close()

os.system("ls " + InputDir + "/*.root > " + "./inputlist.txt") # read input root files 
#os.system("ls " + InputDir + "SingleElectron_140PU_1.root > " + "./inputlist.txt") # read input root files 
#txtfile = open('./inputlist.txt','r')
#lines = txtfile.readlines()
#writefile = open('./inputlist_work.txt','w')
#for line in lines:
#    writefile.write("root://cms-xrdr.sdfarm.kr:1094/" + line)
#
#txtfile.close()
#writefile.close()
...
###################################################
workspace = "/cms/ldap_home/jongho/Track_isolation/Minbias/Results/"
