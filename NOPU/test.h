...
// Tue Jul 17 20:20:55 2018 by ROOT version 6.12/06
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   float vertex(float R1, float Z1, float R2, float Z2, float Vz);
...
float test::vertex(float R1, float Z1, float R2, float Z2, float Vz)
{
    Float_t verPoint = (R2*Z1-R1*Z2)/(R2-R1);
    Float_t result = verPoint - Vz;
    return result;
}
