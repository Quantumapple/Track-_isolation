...
for i in range(1,64):
    txt = "root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/jongho/PhaseII_SE140_CMSSW620_SLHC12_patch1/SingleElectron_140PU_%d.root \n" % i
    textfile.write(txt)
...
###################################################
workspace = "/cms/ldap_home/jongho/Track_isolation/Signal/Results/"
