...
void gaussFit::Loop()
{
   ...
   for(Int_t nth = 0; nth < 10; nth++)
   {
	   ...
	   //Int_t size = genpT_bsl1_l1d1->size();
	   //Int_t size = genpT_bsl1_l1d2->size();
	   //Int_t size = genpT_bsl2_l2d1->size();
	   //Int_t size = genpT_bsl2_l2d2->size();
	   //Int_t size = genpT_bsd1_d1d2->size();
	   //Int_t size = genpT_bsd1_d1d3->size();
	   //Int_t size = genpT_bsd2_d2d4->size();
	   //Int_t size = genpT_bsd2_d2d5->size();
	   //Int_t size = genpT_bsd3_d3d5->size();
	   //Int_t size = genpT_bsd3_d3d6->size();
	   Int_t size = genpT_bsd4_d4d6->size();
	   if( size == 0 ) continue;

       //Float_t gen_pT = genpT_bsl1_l1d1->at(0);
       //Float_t gen_pT = genpT_bsl1_l1d2->at(0);
       //Float_t gen_pT = genpT_bsl2_l2d1->at(0);
       //Float_t gen_pT = genpT_bsl2_l2d2->at(0);
       //Float_t gen_pT = genpT_bsd1_d1d2->at(0);
       //Float_t gen_pT = genpT_bsd1_d1d3->at(0);
       //Float_t gen_pT = genpT_bsd2_d2d4->at(0);
       //Float_t gen_pT = genpT_bsd2_d2d5->at(0);
       //Float_t gen_pT = genpT_bsd3_d3d5->at(0);
       //Float_t gen_pT = genpT_bsd3_d3d6->at(0);
       Float_t gen_pT = genpT_bsd4_d4d6->at(0);
	   if( gen_pT > high_pt || gen_pT < low_pt ) continue;

       //Float_t dphi = bsl1_l1d1_dphi->at(0);
       //Float_t dphi = bsl1_l1d2_dphi->at(0);
       //Float_t dphi = bsl2_l2d1_dphi->at(0);
       //Float_t dphi = bsl2_l2d2_dphi->at(0);
       //Float_t dphi = bsd1_d1d2_dphi->at(0);
       //Float_t dphi = bsd1_d1d3_dphi->at(0);
       //Float_t dphi = bsd2_d2d4_dphi->at(0);
       //Float_t dphi = bsd2_d2d5_dphi->at(0);
       //Float_t dphi = bsd3_d3d5_dphi->at(0);
       //Float_t dphi = bsd3_d3d6_dphi->at(0);
       Float_t dphi = bsd4_d4d6_dphi->at(0);
