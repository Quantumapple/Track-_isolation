...
// Fri Jul 27 04:35:02 2018 by ROOT version 6.10/05
// from TTree L1PiXTRKTree/L1PiXTRKTree
// found on file: SingleEleNoPU__107.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/xrootd/store/user/jhkim/L1Pixel/SE_PU200_HGCAL_EGID/SingleEleNoPU__107.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/xrootd/store/user/jhkim/L1Pixel/SE_PU200_HGCAL_EGID/SingleEleNoPU__107.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("/xrootd/store/user/jhkim/L1Pixel/SE_PU200_HGCAL_EGID/SingleEleNoPU__107.root:/l1PiXTRKTree");
   ...
   outfile = new TFile("roi_median.root","RECREATE");
   out_tree = new TTree("t","t");
}
