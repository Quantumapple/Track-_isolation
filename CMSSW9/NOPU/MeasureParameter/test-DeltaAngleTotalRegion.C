...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   if( eta_flag4 )
   {
      h1->SetTitle("D_{1}D_{2}-D_{1}D_{3}");
      h2->SetTitle("D_{1}D_{2}-D_{2}D_{3}");
      h3->SetTitle("D_{1}D_{3}-D_{2}D_{3}");
      hh1->SetTitle("PVD3-PVD2");
      hh2->SetTitle("PVD3-PVD1");
      hhh1->SetTitle("#Delta#phi[#phi(PVD1)-#phi(D1D2)]-#Delta#phi[#phi(D1D2)-#phi(D2D3)]");
      
      a1->SetTitle("D_{1}D_{2}-D_{1}D_{4}"); 
      a2->SetTitle("D_{1}D_{2}-D_{2}D_{4}"); 
      a3->SetTitle("D_{1}D_{4}-D_{2}D_{4}"); 
      aa1->SetTitle("PVD4-PVD2");
      aa2->SetTitle("PVD4-PVD1");
      aaa1->SetTitle("#Delta#phi[#phi(PVD1)-#phi(D1D2)]-#Delta#phi[#phi(D1D2)-#phi(D2D4)]");
      
      b1->SetTitle("D_{1}D_{3}-D_{1}D_{4}");
      b2->SetTitle("D_{1}D_{3}-D_{3}D_{4}");
      b3->SetTitle("D_{1}D_{4}-D_{3}D_{4}");
      bb1->SetTitle("PVD4-PVD3");
      bbb1->SetTitle("#Delta#phi[#phi(PVD1)-#phi(D1D3)]-#Delta#phi[#phi(D1D3)-#phi(D3D4)]");
      
      c1->SetTitle("D_{2}D_{3}-D_{2}D_{4}");
      c2->SetTitle("D_{2}D_{3}-D_{3}D_{4}");
      c3->SetTitle("D_{2}D_{4}-D_{3}D_{4}");
      ccc1->SetTitle("#Delta#phi[#phi(PVD2)-#phi(D2D3)]-#Delta#phi[#phi(D2D3)-#phi(D3D4)]");
   }
