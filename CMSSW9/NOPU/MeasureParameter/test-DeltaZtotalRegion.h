...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<Float_t> SaveFi_case3;  
   
   vector<Float_t> SaveSe_case1;  
   vector<Float_t> SaveSe_case2;  
   vector<Float_t> SaveSe_case3;  
   
   vector<Float_t> SaveTh_case1;  
   vector<Float_t> SaveTh_case2;  
   vector<Float_t> SaveTh_case3;  
   
   vector<Float_t> SaveFo_case1;  
   vector<Float_t> SaveFo_case2;  

   Float_t std_Vz[3] = {};
   void StorePixelHits(Int_t eta_region, Float_t propGenPhi, Float_t propGenEta);
   void MeasureDeltaZ(Int_t eta_region, Float_t std_genVz, Float_t std_Vz[]);
};
...
void test::MeasureDeltaZ(Int_t eta_region, Float_t std_genVz, Float_t std_Vz[])
{
    if( eta_region == 1 )
    {
        if( std_Vz[0] != 0 ) // L1L3
        { // {{{
            Float_t std_zpL1L3 = std_Vz[0];
            
            // ############ L1L2L3 ############
            if( bLayer1.size() != 0 && bLayer2.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer1[0].pos_x,2)+pow(bLayer1[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                Float_t temp_Z1 = bLayer1[0].pos_z;
                Float_t temp_Z2 = bLayer2[0].pos_z;

                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL1L3 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // L1L3 - L1L2
            }
            
            if( bLayer1.size() != 0 && bLayer3.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer1[0].pos_x,2)+pow(bLayer1[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer3[0].pos_x,2)+pow(bLayer3[0].pos_y,2));
                Float_t temp_Z1 = bLayer1[0].pos_z;
                Float_t temp_Z2 = bLayer3[0].pos_z;

                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL1L3 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // L1L3 - L1L3
            }

            if( bLayer2.size() != 0 && bLayer3.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer3[0].pos_x,2)+pow(bLayer3[0].pos_y,2));
                Float_t temp_Z1 = bLayer2[0].pos_z;
                Float_t temp_Z2 = bLayer3[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // L1L3 - L2L3
            }
        } // }}}

        if( std_Vz[1] != 0 ) // L2L4
        { // {{{
            Float_t std_zpL2L4 = std_Vz[1];
            // ############ L2L3L4 ############
            if( bLayer2.size() != 0 && bLayer3.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL2L4 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case1.push_back(fi_Dz); // L2L4 - L2L3
            }

            if( bLayer2.size() != 0 && bLayer4.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer4[0].pos_x,2)+pow(bLayer4[0].pos_y,2));
                Float_t temp_Z1 = bLayer2[0].pos_z;
                Float_t temp_Z2 = bLayer4[0].pos_z;

                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL2L4 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case2.push_back(fi_Dz); // L2L4 - L2L4
            }

            if( bLayer3.size() != 0 && bLayer4.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer3[0].pos_x,2)+pow(bLayer3[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer4[0].pos_x,2)+pow(bLayer4[0].pos_y,2));
                Float_t temp_Z1 = bLayer3[0].pos_z;
                Float_t temp_Z2 = bLayer4[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case3.push_back(fi_Dz); // L2L4 - L3L4
            }
        } // }}}

        if( std_Vz[2] != 0 ) // L1L4
        { // {{{
            Float_t std_zpL1L4 = std_Vz[2];
            ...
            if( bLayer1.size() != 0 && bLayer2.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL1L4 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case1.push_back(fi_Dz); // L1L4 - L1L2
            }

            if( bLayer1.size() != 0 && bLayer4.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer1[0].pos_x,2)+pow(bLayer1[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(bLayer4[0].pos_x,2)+pow(bLayer4[0].pos_y,2));
                Float_t temp_Z1 = bLayer1[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case2.push_back(fi_Dz); // L1L4 - L1L4
            }
            ...
            if( bLayer2.size() != 0 && bLayer4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case3.push_back(fi_Dz); // L1L4 - L2L4
            }
            ...
            if( bLayer1.size() != 0 && bLayer3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case1.push_back(fi_Dz); // L1L4 - L1L3
            }
            ...
            if( bLayer3.size() != 0 && bLayer4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case2.push_back(fi_Dz); // L1L4 - L3L4
            }
        } // }}}
    }
    ...
    if( eta_region == 2 )
    {
        ...
        { // {{{
            ...
            if( bLayer1.size() != 0 && bLayer3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case2.push_back(fi_Dz); // L1L3 - L1L3
            }
            ...
            if( bLayer2.size() != 0 && bLayer3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case3.push_back(fi_Dz); // L1L3 - L2L3
            }
        } // }}}

        if( std_Vz[1] != 0 ) // L2D1
        { // {{{
            Float_t std_zpL2D1 = std_Vz[1];
            ...
            if( bLayer1.size() != 0 && bLayer2.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL2D1 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case1.push_back(fi_Dz); // L2D1 - L1L2
            }

            if( bLayer1.size() != 0 && fDisk1.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer1[0].pos_x,2)+pow(bLayer1[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk1[0].pos_x,2)+pow(fDisk1[0].pos_y,2));
                Float_t temp_Z1 = bLayer1[0].pos_z;
                Float_t temp_Z2 = fDisk1[0].pos_z;

                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL2D1 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case2.push_back(fi_Dz); // L2D1 - L1D1
            }

            if( bLayer2.size() != 0 && fDisk1.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk1[0].pos_x,2)+pow(fDisk1[0].pos_y,2));
                Float_t temp_Z1 = bLayer2[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case3.push_back(fi_Dz); // L2D1 - L2D1
            }
        } // }}}

        if( std_Vz[2] != 0 ) // L3D1
        { // {{{
            Float_t std_zpL3D1 = std_Vz[2];
            ...
            if( bLayer1.size() != 0 && bLayer3.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL3D1 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case1.push_back(fi_Dz); // L3D1 - L1L3
            }
            ...
            if( bLayer1.size() != 0 && fDisk1.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case2.push_back(fi_Dz); // L3D1 - L1D1
            }

            if( bLayer3.size() != 0 && fDisk1.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer3[0].pos_x,2)+pow(bLayer3[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk1[0].pos_x,2)+pow(fDisk1[0].pos_y,2));
                Float_t temp_Z1 = bLayer3[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case3.push_back(fi_Dz); // L3D1 - L3D1
            }
            ...
            if( bLayer2.size() != 0 && bLayer3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case1.push_back(fi_Dz); // L3D1 - L2L3
            }
            ...
            if( bLayer2.size() != 0 && fDisk1.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case2.push_back(fi_Dz); // L3D1 - L2D1
            }
        } // }}}
    }
    ...
    if( eta_region == 3 )
    {
        ...
        { // {{{
            ...
            if( bLayer1.size() != 0 && bLayer2.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // L2D1 - L1L2
            }
            ...
            if( bLayer1.size() != 0 && fDisk1.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case2.push_back(fi_Dz); // L2D1 - L1D1
            }
            ...
            if( bLayer2.size() != 0 && fDisk1.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case3.push_back(fi_Dz); // L2D1 - L2D1
            }
        } // }}}

        if( std_Vz[1] != 0 ) // L1D2
        { // {{{
            Float_t std_zpL1D2 = std_Vz[1];
        ...
        { // {{{
            ...
            if( bLayer1.size() != 0 && bLayer2.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpL2D2 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case1.push_back(fi_Dz); // L2D2 - L1L2
            }
            ...
            if( bLayer1.size() != 0 && fDisk2.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case2.push_back(fi_Dz); // L2D2 - L1D2
            }

            if( bLayer2.size() != 0 && fDisk2.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(bLayer2[0].pos_x,2)+pow(bLayer2[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk2[0].pos_x,2)+pow(fDisk2[0].pos_y,2));
                Float_t temp_Z1 = bLayer2[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case3.push_back(fi_Dz); // L2D2 - L2D2
            }
            ...
            if( bLayer2.size() != 0 && fDisk1.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case1.push_back(fi_Dz); // L2D2 - L2D1
            }
            ...
            if( fDisk1.size() != 0 && fDisk2.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case2.push_back(fi_Dz); // L2D2 - D1D2
            }
        } // }}}
    }
    ...
    if( eta_region == 4 )
    {
        ...
        { // {{{
            ...
            if( fDisk1.size() != 0 && fDisk2.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // D1D3 - D1D2
            }
            ...
            if( fDisk1.size() != 0 && fDisk3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case2.push_back(fi_Dz); // D1D3 - D1D3
            }
            ...
            if( fDisk2.size() != 0 && fDisk3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case3.push_back(fi_Dz); // D1D3 - D2D3
            }
        } // }}}
        ...
        { // {{{
            ...
            if( fDisk1.size() != 0 && fDisk2.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpD1D4 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case1.push_back(fi_Dz); // D1D4 - D1D2
            }

            if( fDisk1.size() != 0 && fDisk4.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(fDisk1[0].pos_x,2)+pow(fDisk1[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk4[0].pos_x,2)+pow(fDisk4[0].pos_y,2));
                Float_t temp_Z1 = fDisk1[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case2.push_back(fi_Dz); // D1D4 - D1D4
            }
            ...
            if( fDisk2.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case3.push_back(fi_Dz); // D1D4 - D2D4
            }
            ...
            if( fDisk1.size() != 0 && fDisk3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case1.push_back(fi_Dz); // D1D4 - D1D3
            }
            ...
            if( fDisk3.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case2.push_back(fi_Dz); // D1D4 - D3D4
            }
        } // }}}
    }
    ...
    if( eta_region == 5 )
    {
        ...
        { // {{{
            ...
            if( fDisk2.size() != 0 && fDisk3.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case1.push_back(fi_Dz); // D2D4 - D2D3
            }
            ...
            if( fDisk2.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case2.push_back(fi_Dz); // D2D4 - D2D4
            }
            ...
            if( fDisk3.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFi_case3.push_back(fi_Dz); // D2D4 - D3D4
            }
        } // }}}

        if( std_Vz[1] != 0 ) // D3D5
        { // {{{
            Float_t std_zpD3D5 = std_Vz[1];
            ...
            if( fDisk3.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case1.push_back(fi_Dz); // D3D5 - D3D4
            }
            ...
            if( fDisk3.size() != 0 && fDisk5.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case2.push_back(fi_Dz); // D3D5 - D3D5
            }
            ...
            if( fDisk4.size() != 0 && fDisk5.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveSe_case3.push_back(fi_Dz); // D3D5 - D4D5
            }
        } // }}}

        if( std_Vz[2] != 0 ) // D2D5
        { // {{{
            Float_t std_zpD2D5 = std_Vz[2];
            ...
            if( fDisk2.size() != 0 && fDisk3.size() != 0 )
            {
                ...
                Float_t temp_Vz = (temp_R2*temp_Z1 - temp_R1*temp_Z2)/(temp_R2 - temp_R1);
                Float_t temp_Dz = std_zpD2D5 - temp_Vz;
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case1.push_back(fi_Dz); // D2D5 - D2D3
            }

            if( fDisk2.size() != 0 && fDisk5.size() != 0 )
            {
                Float_t temp_R1 = sqrt(pow(fDisk2[0].pos_x,2)+pow(fDisk2[0].pos_y,2));
                Float_t temp_R2 = sqrt(pow(fDisk5[0].pos_x,2)+pow(fDisk5[0].pos_y,2));
                Float_t temp_Z1 = fDisk2[0].pos_z;
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case2.push_back(fi_Dz); // D2D5 - D2D5
            }
            ...
            if( fDisk3.size() != 0 && fDisk5.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveTh_case3.push_back(fi_Dz); // D2D5 - D3D5
            }
            ...
            if( fDisk2.size() != 0 && fDisk4.size() != 0 )
            {
                ...
                Float_t gen_corr = std_genVz - simVz->at(0);
                Float_t fi_Dz = fabs(temp_Dz) - fabs(gen_corr);
                SaveFo_case1.push_back(fi_Dz); // D2D5 - D2D4
            }
