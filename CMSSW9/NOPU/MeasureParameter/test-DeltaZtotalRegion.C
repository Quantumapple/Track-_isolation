...
void test::Loop()
{
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //cout << "Size of layers" << endl;
      //cout << bLayer1.size() << ", " << bLayer2.size() << ", " << bLayer3.size() << ", " << bLayer4.size() << endl;
      
      //cout << "Size of disks" << endl;
      //cout << fDisk1.size() << ", " << fDisk2.size() << ", " << fDisk3.size() << ", " << fDisk4.size() << ", " << fDisk5.size() << ", " << fDisk6.size() << endl;
      ...
      { 
          ...
          if( eta_region == 4 )
          {
              if( fR[0] && fZ[0] && fR[2] && fZ[2] ) std_Vz[0] = (fR[2]*fZ[0]-fR[0]*fZ[2])/(fR[2]-fR[0]); else std_Vz[0] = 0.; // D1D3
              if( fR[1] && fZ[1] && fR[3] && fZ[3] ) std_Vz[1] = (fR[3]*fZ[1]-fR[1]*fZ[3])/(fR[3]-fR[1]); else std_Vz[1] = 0.; // D2D4
              if( fR[0] && fZ[0] && fR[3] && fZ[3] ) std_Vz[2] = (fR[3]*fZ[0]-fR[0]*fZ[3])/(fR[3]-fR[0]); else std_Vz[2] = 0.; // D1D4
          }
   ...
   if( eta_flag4 )
   {
      a1->SetTitle("D_{1}D_{3}-D_{1}D_{2}");
      a2->SetTitle("D_{1}D_{3}-D_{1}D_{3}");
      a3->SetTitle("D_{1}D_{3}-D_{2}D_{3}");
      
      b1->SetTitle("D_{2}D_{4}-D_{2}D_{3}");
      b2->SetTitle("D_{2}D_{4}-D_{2}D_{4}");
      b3->SetTitle("D_{2}D_{4}-D_{3}D_{4}");
      
      c1->SetTitle("D_{1}D_{4}-D_{1}D_{2}");
      c2->SetTitle("D_{1}D_{4}-D_{1}D_{4}");
      c3->SetTitle("D_{1}D_{4}-D_{2}D_{4}");
      
      d1->SetTitle("D_{1}D_{4}-D_{1}D_{3}");
      d2->SetTitle("D_{1}D_{4}-D_{3}D_{4}");
   }
