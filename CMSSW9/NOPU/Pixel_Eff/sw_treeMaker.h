...
// Tue Aug  7 21:05:40 2018 by ROOT version 6.12/06
// from TTree L1PiXTRKTree/L1PiXTRKTree
// found on file: SingleEleNoPU.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("SingleEleNoPU.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("SingleEleNoPU.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("SingleEleNoPU.root:/l1PiXTRKTree");
