...
// Wed Sep  5 01:33:49 2018 by ROOT version 6.12/06
// from TTree t/t
// found on file: Tree_SE_PU200.root
//////////////////////////////////////////////////////////

#ifndef eff_plot_my_h
#define eff_plot_my_h
...
#ifdef eff_plot_my_cxx
eff_plot_my::eff_plot_my(TTree *tree) : fChain(0) 
{
...
eff_plot_my::~eff_plot_my()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t eff_plot_my::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t eff_plot_my::LoadTree(Long64_t entry)
{
...
void eff_plot_my::Init(TTree *tree)
{
...
void eff_plot_my::Show(Long64_t entry)
{
...
Int_t eff_plot_my::Cut(Long64_t entry)
{
