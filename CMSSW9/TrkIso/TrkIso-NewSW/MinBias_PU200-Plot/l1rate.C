...
void l1rate::Loop()
{
   ...
   //float genN = 487880.00; 
   float genN = 488600.00; 
   int eta_r = 1;
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      for(int i=0; i < ntnEg2; i++){
         ...
         //if(eta_r == 0 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) < 2.5) ) max_eget = ntEgEt->at(i);
         if(eta_r == 1 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) < 2.5) ) max_eget = ntEgEt->at(i);
         //if(eta_r == 1 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) < 0.8) ) max_eget = ntEgEt->at(i);
         //if(eta_r == 2 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) > 0.8 && fabs(ntEgEta->at(i)) < 1.4) ) max_eget = ntEgEt->at(i);
         //if(eta_r == 3 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) > 1.4 && fabs(ntEgEta->at(i)) < 2.5) ) max_eget = ntEgEt->at(i);
         //if(eta_r == 4 && ntEgEt->at(i) > max_eget && (fabs(ntEgEta->at(i)) > 1.7 && fabs(ntEgEta->at(i)) < 2.9) ) max_eget = ntEgEt->at(i);
           
      }// eg loop

      float max_pxeget = -999.;
      for(int i=0; i < ntnEg2; i++){
         //if(eta_r == 0 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) < 1.5)) max_pxeget = ntEgEt->at(i);
         //if(eta_r == 0 && ntEgEt->at(i) > max_pxeget && ((trigger_bit_width->at(i)&width_bit[0])==width_bit[0]) && (fabs(ntEgEta->at(i)) < 2.5)) max_pxeget = ntEgEt->at(i);
         //if(eta_r == 1 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) < 0.8)) max_pxeget = ntEgEt->at(i);
         if(eta_r == 1 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) < 2.5)) max_pxeget = ntEgEt->at(i);
         //if(eta_r == 2 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) > 0.8 && fabs(ntEgEta->at(i)) < 1.4)) max_pxeget = ntEgEt->at(i);
         //if(eta_r == 3 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) > 1.4 && fabs(ntEgEta->at(i)) < 2.5)) max_pxeget = ntEgEt->at(i);
         //if(eta_r == 4 && ntEgEt->at(i) > max_pxeget && ntCl_match->at(i) && (fabs(ntEgEta->at(i)) > 1.7 && fabs(ntEgEta->at(i)) < 2.9)) max_pxeget = ntEgEt->at(i);
      ...
      for(int i=0; i < ntL1TkEgEt->size(); i++){
         ...
         //if(eta_r == 0 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) < 2.5)) max_tkeget = ntL1TkEgEt->at(i);
         if(eta_r == 1 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) < 2.5)) max_tkeget = ntL1TkEgEt->at(i);
         //if(eta_r == 1 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) < 0.8)) max_tkeget = ntL1TkEgEt->at(i);
         //if(eta_r == 2 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) > 0.8 && fabs(ntL1TkEgEta->at(i)) < 1.4)) max_tkeget = ntL1TkEgEt->at(i);
         //if(eta_r == 3 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) > 1.4 && fabs(ntL1TkEgEta->at(i)) < 2.5)) max_tkeget = ntL1TkEgEt->at(i);
         //if(eta_r == 4 && ntL1TkEgEt->at(i) > max_tkeget && (fabs(ntL1TkEgEta->at(i)) > 1.9 && fabs(ntL1TkEgEta->at(i)) < 2.5)) max_tkeget = ntL1TkEgEt->at(i);
      }// tkeg loop
      ...
      for(int i=0; i < ntL1TkLooseEgEt->size(); i++){
         ...
         //if(eta_r == 0 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) < 2.5)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
         if(eta_r == 1 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) < 2.5)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
         //if(eta_r == 1 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) < 0.8)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
         //if(eta_r == 2 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) > 0.8 && fabs(ntL1TkLooseEgEta->at(i)) < 1.4)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
         //if(eta_r == 3 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) > 1.4 && fabs(ntL1TkLooseEgEta->at(i)) < 2.5)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
         //if(eta_r == 4 && ntL1TkLooseEgEt->at(i) > max_tklooseeget && (fabs(ntL1TkLooseEgEta->at(i)) > 1.9 && fabs(ntL1TkLooseEgEta->at(i)) < 2.5)) max_tklooseeget = ntL1TkLooseEgEt->at(i);
      } // tklooseEg loop
   ...
   //if(eta_r == 2) eta_str = "#it{1.3 < #lbar#bf{#eta}#lbar < 1.6}";
   //if(eta_r == 3) eta_str = "#it{1.6 < #lbar#bf{#eta}#lbar < 1.9}";
   //if(eta_r == 4) eta_str = "#it{1.7 < #lbar#bf{#eta}#lbar < 2.9}";
   ...
   cout << "11px bin: " << r_PXEG->GetBinContent(16) << " error: " << r_PXEG->GetBinError(16) << endl;
   cout << "11px iso bin: " << r_PXIsoEG->GetBinContent(16) << " error: " << r_PXIsoEG->GetBinError(16) << endl;
