...
void test::Loop()
{
   ...
   TH1F *h3 = new TH1F("h3","Pixel track pT distribution; Estimated pT (GeV); ",100,0,1000);
    
   TH2F *a1 = new TH2F("genVSreco1","Gen level p_{T} - the highest reco p_{T}; Gen level p_{T}; the highest reco p_{T}",1000,0,100,5000,0,500);
   TH2F *a2 = new TH2F("genVSreco2","p_{T} resolution; Gen level p_{T}; (gen p_{T} - reco p_{T})/gen p_{T}",1000,0,100,200,-10,10);
   ...
   //for (Long64_t jentry=0; jentry<10;jentry++) { //nentries
     ...
     if( all.size() == 0 ) { 
        ...
        track_pT15.push_back(-999.);
         ...
         Float_t highest_pT = -1.;
         for(Int_t k = 0; k < vec_size; k++) { denomi += pT_vector.at(k); h3->Fill(pT_vector.at(k)); highest_pT = pT_vector.at(k); }
         ...
         switch( all_size ) {
            case 1:
                IsoValue.push_back(0);
                track_pT1.push_back(pT_vector.at(0));
                track_pT2.push_back(-999.);
                track_pT3.push_back(-999.);
                track_pT4.push_back(-999.);
                track_pT5.push_back(-999.);
            ...
            case 2:
                ...
                track_pT1.push_back(pT_vector.at(0));
                track_pT2.push_back(pT_vector.at(1));
                track_pT3.push_back(-999.);
                track_pT4.push_back(-999.);
                track_pT5.push_back(-999.);
                track_pT6.push_back(-999.);
            ...
            case 3:
                ...
                track_pT1.push_back(pT_vector.at(0));
                track_pT2.push_back(pT_vector.at(1));
                track_pT3.push_back(pT_vector.at(2));
                track_pT4.push_back(-999.);
                track_pT5.push_back(-999.);
                track_pT6.push_back(-999.);
                track_pT7.push_back(-999.);
            ...
            case 4:
                ...
                track_pT2.push_back(pT_vector.at(1));
                track_pT3.push_back(pT_vector.at(2));
                track_pT4.push_back(pT_vector.at(3));
                track_pT5.push_back(-999.);
                track_pT6.push_back(-999.);
                track_pT7.push_back(-999.);
                track_pT8.push_back(-999.);
            ...
            case 5:
                ...
                track_pT3.push_back(pT_vector.at(2));
                track_pT4.push_back(pT_vector.at(3));
                track_pT5.push_back(pT_vector.at(4));
                track_pT6.push_back(-999.);
                track_pT7.push_back(-999.);
                track_pT8.push_back(-999.);
                track_pT9.push_back(-999.);
            ...
            case 6:
                ...
                track_pT4.push_back(pT_vector.at(3));
                track_pT5.push_back(pT_vector.at(4));
                track_pT6.push_back(pT_vector.at(5));
                track_pT7.push_back(-999.);
                track_pT8.push_back(-999.);
                track_pT9.push_back(-999.);
                track_pT10.push_back(-999.);
            ...
            case 7:
                ...
                track_pT5.push_back(pT_vector.at(4));
                track_pT6.push_back(pT_vector.at(5));
                track_pT7.push_back(pT_vector.at(6));
                track_pT8.push_back(-999.);
                track_pT9.push_back(-999.);
                track_pT10.push_back(-999.);
                track_pT11.push_back(-999.);
            ...
            case 8:
                ...
                track_pT6.push_back(pT_vector.at(5));
                track_pT7.push_back(pT_vector.at(6));
                track_pT8.push_back(pT_vector.at(7));
                track_pT9.push_back(-999.);
                track_pT10.push_back(-999.);
                track_pT11.push_back(-999.);
                track_pT12.push_back(-999.);
            ...
            case 9:
                ...
                track_pT7.push_back(pT_vector.at(6));
                track_pT8.push_back(pT_vector.at(7));
                track_pT9.push_back(pT_vector.at(8));
                track_pT10.push_back(-999.);
                track_pT11.push_back(-999.);
                track_pT12.push_back(-999.);
                track_pT13.push_back(-999.);
            ...
            case 10:
                ...
                track_pT8.push_back(pT_vector.at(7));
                track_pT9.push_back(pT_vector.at(8));
                track_pT10.push_back(pT_vector.at(9));
                track_pT11.push_back(-999.);
                track_pT12.push_back(-999.);
                track_pT13.push_back(-999.);
                track_pT14.push_back(-999.);
            ...
            case 11:
                ...
                track_pT9.push_back(pT_vector.at(8));
                track_pT10.push_back(pT_vector.at(9));
                track_pT11.push_back(pT_vector.at(10));
                track_pT12.push_back(-999.);
                track_pT13.push_back(-999.);
                track_pT14.push_back(-999.);
                track_pT15.push_back(-999.);
            ...
            case 12:
                ...
                track_pT10.push_back(pT_vector.at(9));
                track_pT11.push_back(pT_vector.at(10));
                track_pT12.push_back(pT_vector.at(11));
                track_pT13.push_back(-999.);
                track_pT14.push_back(-999.);
                track_pT15.push_back(-999.);
                break;
            case 13:
                ...
                track_pT11.push_back(pT_vector.at(10));
                track_pT12.push_back(pT_vector.at(11));
                track_pT13.push_back(pT_vector.at(12));
                track_pT14.push_back(-999.);
                track_pT15.push_back(-999.);
                break;
            case 14:
                ...
                track_pT12.push_back(pT_vector.at(11));
                track_pT13.push_back(pT_vector.at(12));
                track_pT14.push_back(pT_vector.at(13));
                track_pT15.push_back(-999.);
                break;
            case 15:
                IsoValue.push_back(ratio);
                ...
                track_pT13.push_back(pT_vector.at(12));
                track_pT14.push_back(pT_vector.at(13));
                track_pT15.push_back(pT_vector.at(14));
                break;
         } // switch function

         
         //a1->Fill(nt_genPt, highest_pT);
         //a2->Fill(nt_genPt, (nt_genPt-highest_pT)/nt_genPt );
