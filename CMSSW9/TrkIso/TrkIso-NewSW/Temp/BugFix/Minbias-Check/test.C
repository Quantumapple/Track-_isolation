...
void test::Loop()
{
   ...
   TH1F *h2 = new TH1F("h2","Number of pixel track distribution; Number of tracks; ",30,0,30);
   TH1F *h3 = new TH1F("h3","Pixel track pT distribution; Estimated pT (GeV); ",10000,0,1000);
   ...
   for (Long64_t jentry=577; jentry<578;jentry++) { //nentries
     ...
     // %%%%%%%%%%%%%%%%%%%%% Track isolation algorithm %%%%%%%%%%%%%%%%%%%%%
      ...
      gr1->SetPoint(0,0.,0.);
      gr1->SetPoint(1,all[0].pos_x1,all[0].pos_y1);
      gr1->SetPoint(2,all[0].pos_x2,all[0].pos_y2);
      gr1->SetPoint(3,all[0].pos_x3,all[0].pos_y3);
      
      TGraph *gr2 = new TGraph();
      gr2->SetPoint(0,0.,0.);
      gr2->SetPoint(1,all[1].pos_x1,all[1].pos_y1);
      gr2->SetPoint(2,all[1].pos_x2,all[1].pos_y2);
      gr2->SetPoint(3,all[1].pos_x3,all[1].pos_y3);
      
      TGraph *gr3 = new TGraph();
      gr3->SetPoint(0,0.,0.);
      gr3->SetPoint(1,all[2].pos_x1,all[2].pos_y1);
      gr3->SetPoint(2,all[2].pos_x2,all[2].pos_y2);
      gr3->SetPoint(3,all[2].pos_x3,all[2].pos_y3);
      
      TGraph *gr4 = new TGraph();
      gr4->SetPoint(0,0.,0.);
      gr4->SetPoint(1,all[3].pos_x1,all[3].pos_y1);
      gr4->SetPoint(2,all[3].pos_x2,all[3].pos_y2);
      gr4->SetPoint(3,all[3].pos_x3,all[3].pos_y3);
      
      TGraph *gr5 = new TGraph();
      gr5->SetPoint(0,0.,0.);
      gr5->SetPoint(1,all[4].pos_x1,all[4].pos_y1);
      gr5->SetPoint(2,all[4].pos_x2,all[4].pos_y2);
      gr5->SetPoint(3,all[4].pos_x3,all[4].pos_y3);

      TGraph *g1 = new TGraph();
      g1->SetPoint(0,recoPV, 0.);
      g1->SetPoint(1,all[0].pos_z1,sqrt(pow(all[0].pos_x1,2)+pow(all[0].pos_y1,2)));
      g1->SetPoint(2,all[0].pos_z2,sqrt(pow(all[0].pos_x2,2)+pow(all[0].pos_y2,2)));
      g1->SetPoint(3,all[0].pos_z3,sqrt(pow(all[0].pos_x3,2)+pow(all[0].pos_y3,2)));
   
      TGraph *g2 = new TGraph();
      g2->SetPoint(0,recoPV, 0.);
      g2->SetPoint(1,all[1].pos_z1,sqrt(pow(all[1].pos_x1,2)+pow(all[1].pos_y1,2)));
      g2->SetPoint(2,all[1].pos_z2,sqrt(pow(all[1].pos_x2,2)+pow(all[1].pos_y2,2)));
      g2->SetPoint(3,all[1].pos_z3,sqrt(pow(all[1].pos_x3,2)+pow(all[1].pos_y3,2)));
      
      TGraph *g3 = new TGraph();
      g3->SetPoint(0,recoPV, 0.);
      g3->SetPoint(1,all[2].pos_z1,sqrt(pow(all[2].pos_x1,2)+pow(all[2].pos_y1,2)));
      g3->SetPoint(2,all[2].pos_z2,sqrt(pow(all[2].pos_x2,2)+pow(all[2].pos_y2,2)));
      g3->SetPoint(3,all[2].pos_z3,sqrt(pow(all[2].pos_x3,2)+pow(all[2].pos_y3,2)));
      
      TGraph *g4 = new TGraph();
      g4->SetPoint(0,recoPV, 0.);
      g4->SetPoint(1,all[3].pos_z1,sqrt(pow(all[3].pos_x1,2)+pow(all[3].pos_y1,2)));
      g4->SetPoint(2,all[3].pos_z2,sqrt(pow(all[3].pos_x2,2)+pow(all[3].pos_y2,2)));
      g4->SetPoint(3,all[3].pos_z3,sqrt(pow(all[3].pos_x3,2)+pow(all[3].pos_y3,2)));
      
      TGraph *g5 = new TGraph();
      g5->SetPoint(0,recoPV, 0.);
      g5->SetPoint(1,all[4].pos_z1,sqrt(pow(all[4].pos_x1,2)+pow(all[4].pos_y1,2)));
      g5->SetPoint(2,all[4].pos_z2,sqrt(pow(all[4].pos_x2,2)+pow(all[4].pos_y2,2)));
      g5->SetPoint(3,all[4].pos_z3,sqrt(pow(all[4].pos_x3,2)+pow(all[4].pos_y3,2)));
      ...
      gr2->SetLineColor(kSpring-3);
      gr2->SetMarkerColor(kSpring-3);
      gr2->SetLineWidth(2);
      g2->SetMarkerStyle(20);
      g2->SetMarkerSize(2.5);
      g2->SetLineColor(kSpring-3);
      g2->SetMarkerColor(kSpring-3);
      g2->SetLineWidth(2);
      ...
      gr4->SetLineColor(kPink+7);
      gr4->SetMarkerColor(kPink+7);
      gr4->SetLineWidth(2);
      g4->SetMarkerStyle(20);
      g4->SetMarkerSize(2.5);
      g4->SetLineColor(kPink+7);
      g4->SetMarkerColor(kPink+7);
      g4->SetLineWidth(2);
      
      gr5->SetMarkerStyle(20);
      gr5->SetMarkerSize(2.5);
      gr5->SetLineColor(kCyan-4);
      gr5->SetMarkerColor(kCyan-4);
      gr5->SetLineWidth(2);
      g5->SetMarkerStyle(20);
      g5->SetMarkerSize(2.5);
      g5->SetLineColor(kCyan-4);
      g5->SetMarkerColor(kCyan-4);
      g5->SetLineWidth(2);
      ...
      if( all.size() == 0 ) { 
          ...
          for(Int_t k = 0; k < vec_size; k++) { denomi += pT_vector.at(k); h3->Fill(pT_vector.at(k)); }
