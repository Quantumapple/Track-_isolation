...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      string line;
      ifstream myfile("MinBias_PU200_4.txt"); // MinBias_PU200_4.txt will be replaced by the name of txt file that contains the location of input files
      if (myfile.is_open())
        {
   ...
   //file3 = new TFile("../output_tmp/Tree_MinBias_PU200_4.root","recreate");
   file3 = new TFile("test.root","recreate");
