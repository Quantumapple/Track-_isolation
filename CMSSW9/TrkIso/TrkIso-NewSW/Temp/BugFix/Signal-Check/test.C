...
void test::Loop()
{
   ...
   TH2F *h1 = new TH2F("h1","RZ pixel clusters",2000,-20,20,1000,0,20);

   //for (Long64_t jentry=0; jentry<nentries;jentry++) { //nentries
   for (Long64_t jentry=0; jentry<1;jentry++) { //nentries
     ...
     pixelXY->SetPoint(0, 0., 0.);
     pixelXY->SetPoint(1, all[0].pos_x1, all[0].pos_y1);
     pixelXY->SetPoint(2, all[0].pos_x2, all[0].pos_y2);
     pixelXY->SetPoint(3, all[0].pos_x3, all[0].pos_y3);
     ...
     pixelRZ->SetPoint(0, recoPV, 0.);
     pixelRZ->SetPoint(1, all[0].pos_z1, sqrt(pow(all[0].pos_x1,2) + pow(all[0].pos_y1,2)));
     pixelRZ->SetPoint(2, all[0].pos_z2, sqrt(pow(all[0].pos_x2,2) + pow(all[0].pos_y2,2)));
     pixelRZ->SetPoint(3, all[0].pos_z3, sqrt(pow(all[0].pos_x3,2) + pow(all[0].pos_y3,2)));
     ...
     Float_t EgGr = sqrt(pow(EgGx,2)+pow(EgGy,2));
     Float_t EgGr_RZ = sqrt(pow(EgGr,2)+pow(EgGz,2));

     TGraph *propGenXY = new TGraph();
     propGenXY->SetPoint(0, 0., 0.);
     propGenXY->SetPoint(1, EgGr*cos(nt_genPhi), EgGr*sin(nt_genPhi));
     ...
     //TF1 *propGenXY = new TF1("propGenXY","[0]*x + [1]",0,10);
     //propGenXY->SetParName(0, "slope");
     //propGenXY->SetParameter(0, tan(nt_genPhi));
     //propGenXY->SetParName(1, "intercept");
     //propGenXY->SetParameter(1, 0.);
     //propGenXY->SetLineWidth(2);
     //propGenXY->SetLineColor(kRed);

     Float_t propGenTheta = 2.*atan(exp(-nt_genEta));
     TGraph *propGenRZ = new TGraph();
     propGenRZ->SetPoint(0, recoPV, 0.);
     propGenRZ->SetPoint(1, EgGr_RZ*cos(propGenTheta), EgGr_RZ*sin(propGenTheta));
     ...
     //TF1 *propGenRZ = new TF1("propGenRZ","[0]*x + [1]",0,10);
     //propGenRZ->SetParName(0, "slope");
     //propGenRZ->SetParameter(0, tan(propGenTheta));
     //propGenRZ->SetParName(1, "intercept");
     //propGenRZ->SetParameter(1, recoPV);
     //propGenRZ->SetLineWidth(2);
     //propGenRZ->SetLineColor(kRed);
     
     TGraph *GenXY = new TGraph();
     GenXY->SetPoint(0, 0., 0.);
     GenXY->SetPoint(1, EgGr*cos(genPartPhi->at(1)), EgGr*sin(genPartPhi->at(1)));
     ...
     //TF1 *GenXY = new TF1("GenXY","[0]*x + [1]",0,10);
     //GenXY->SetParName(0, "slope");
     //GenXY->SetParameter(0, tan(genPartPhi->at(1)));
     //GenXY->SetParName(1, "intercept");
     //GenXY->SetParameter(1, 0.);
     //GenXY->SetLineWidth(2);
     //GenXY->SetLineColor(kOrange);
     
     Float_t GenTheta = 2.*atan(exp(-genPartEta->at(1)));
     TGraph *GenRZ = new TGraph();
     GenRZ->SetPoint(0, recoPV, 0.);
     GenRZ->SetPoint(1, EgGr_RZ*cos(GenTheta), EgGr_RZ*sin(GenTheta));
     ...
     //TF1 *GenRZ = new TF1("GenRZ","[0]*x + [1]",0,10);
     //GenRZ->SetParName(0, "slope");
     //GenRZ->SetParameter(0, tan(GenTheta));
     //GenRZ->SetParName(1, "intercept");
     //GenRZ->SetParameter(1, recoPV);
     //GenRZ->SetLineWidth(2);
     //GenRZ->SetLineColor(kOrange);
     
     TGraph *EgXY = new TGraph();
     EgXY->SetPoint(0, 0., 0.);
     EgXY->SetPoint(1, EgGr*cos(EgPhi), EgGr*sin(EgPhi));
     EgXY->SetMarkerSize(1.5);
     EgXY->SetMarkerColor(kViolet);
     EgXY->SetMarkerStyle(22);
     EgXY->SetLineWidth(2);
     EgXY->SetLineColor(kViolet);
     EgXY->SetLineStyle(9);

     //TF1 *EgXY = new TF1("EgXY","[0]*x + [1]",0,10);
     //EgXY->SetParName(0, "slope");
     //EgXY->SetParameter(0, tan(EgPhi));
     //EgXY->SetParName(1, "intercept");
     //EgXY->SetParameter(1, 0.);
     //EgXY->SetLineWidth(2);
     //EgXY->SetLineColor(kViolet);
     
     Float_t EgTheta = 2.*atan(exp(-EgEta));
     TGraph *EgRZ = new TGraph();
     EgRZ->SetPoint(0, recoPV, 0.);
     EgRZ->SetPoint(1, EgGr_RZ*cos(EgTheta), EgGr_RZ*sin(EgTheta));
     EgRZ->SetMarkerSize(1.5);
     EgRZ->SetMarkerColor(kViolet);
     EgRZ->SetMarkerStyle(22);
     EgRZ->SetLineWidth(2);
     EgRZ->SetLineColor(kViolet);
     EgRZ->SetLineStyle(9);
     
     //TF1 *EgRZ = new TF1("EgRZ","[0]*x + [1]",0,10);
     //EgRZ->SetParName(0, "slope");
     //EgRZ->SetParameter(0, tan(EgTheta));
     //EgRZ->SetParName(1, "intercept");
     //EgRZ->SetParameter(1, recoPV);
     //EgRZ->SetLineWidth(2);
     //EgRZ->SetLineColor(kViolet);
     ...
     TVector3 verPix1; verPix1.SetXYZ( all[0].pos_x1, all[0].pos_y1, all[0].pos_z1 - recoPV );
     TVector3 verPix2; verPix2.SetXYZ( all[0].pos_x2, all[0].pos_y2, all[0].pos_z2 - recoPV );
     TVector3 verPix3; verPix3.SetXYZ( all[0].pos_x3, all[0].pos_y3, all[0].pos_z3 - recoPV );
     TVector3 Pix1to2; Pix1to2.SetXYZ( all[0].pos_x2 - all[0].pos_x1, all[0].pos_y2 - all[0].pos_y1, all[0].pos_z2 - all[0].pos_z1 );
     TVector3 Pix1to3; Pix1to3.SetXYZ( all[0].pos_x3 - all[0].pos_x1, all[0].pos_y3 - all[0].pos_y1, all[0].pos_z3 - all[0].pos_z1 );
     TVector3 Pix2to3; Pix2to3.SetXYZ( all[0].pos_x3 - all[0].pos_x2, all[0].pos_y3 - all[0].pos_y2, all[0].pos_z3 - all[0].pos_z2 );

     cout << endl;
     cout << "Comparision of phi" << endl;
     cout << "  Gen-level direction: " << genPartPhi->at(1) << endl;
     cout << "  PropGen-level direction: " << nt_genPhi << endl;
     cout << "  L1-EG-object direction: " << EgPhi << endl;
     cout << "   Pixel vertex-1st phi: " << verPix1.Phi() << endl;
     cout << "   Pixel vertex-2nd phi: " << verPix2.Phi() << endl;
     cout << "   Pixel vertex-3rd phi: " << verPix3.Phi() << endl;
     cout << "   Pixel 1st-2nd phi: " << Pix1to2.Phi() << endl;
     cout << "   Pixel 1st-3rd phi: " << Pix1to3.Phi() << endl;
     cout << "   Pixel 2nd-3rd phi: " << Pix2to3.Phi() << endl;
     cout << endl;
     cout << "=======================================================" << endl;
     cout << endl;
     cout << "Comparision of eta" << endl;
     cout << "  Gen-level direction: " << genPartEta->at(1) << endl;
     cout << "  PropGen-level direction: " << nt_genEta << endl;
     cout << "  L1-EG-object direction: " << EgEta << endl;
     cout << "   Pixel vertex-1st phi: " << verPix1.Eta() << endl;
     cout << "   Pixel vertex-2nd phi: " << verPix2.Eta() << endl;
     cout << "   Pixel vertex-3rd phi: " << verPix3.Eta() << endl;
     cout << "   Pixel 1st-2nd phi: " << Pix1to2.Eta() << endl;
     cout << "   Pixel 1st-3rd phi: " << Pix1to3.Eta() << endl;
     cout << "   Pixel 2nd-3rd phi: " << Pix2to3.Eta() << endl;
     cout << endl;
