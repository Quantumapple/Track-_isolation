...
InputDir = "/xrootd/store/user/jhkim/L1Pixel/MinBias_PU200_HGCAL_EGID"
...
writefile = open("./inputlist_MinBias_PU200_HGCAL_EGID.txt",'w')
for line in lines:
    writefile.write("root://cms-xrdr.sdfarm.kr:1094//xrd/store/user/jhkim/L1Pixel/MinBias_PU200_HGCAL_EGID/" + line)
...
###################################################
workspace = "/cms/ldap_home/jongho/L1PixelTrigger/L1PixEle-cmssw9/TrkIso/L1PixEle-Rate/Results/"
...
fr = open('./inputlist_MinBias_PU200_HGCAL_EGID.txt', 'r')
