...
void test::Loop()
{
   ...
   for (Long64_t jentry=700; jentry<799;jentry++) { //nentries
...
*/
     ...
     // If there is no PiXTRK matching, continue
     ...
     for(Int_t i = 0; i < bHitN; i++)
     {
         ...
         if( R < 5. && deltaR < 0.3 )             L1.push_back(TVector3(bHitGx->at(i),bHitGy->at(i),bHitGz->at(i)));
         if( R > 5. && R < 9. && deltaR < 0.3 )   L2.push_back(TVector3(bHitGx->at(i),bHitGy->at(i),bHitGz->at(i)));
         if( R > 9. && R < 14. && deltaR < 0.3 )  L3.push_back(TVector3(bHitGx->at(i),bHitGy->at(i),bHitGz->at(i)));
         if( R > 14. && R < 18. && deltaR < 0.3 ) L4.push_back(TVector3(bHitGx->at(i),bHitGy->at(i),bHitGz->at(i)));
