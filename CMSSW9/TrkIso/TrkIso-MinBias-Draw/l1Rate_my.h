...
// Wed Sep  5 00:26:47 2018 by ROOT version 6.12/06
// from TTree t/t
// found on file: Tree_MinBias_PU200_modified.root
//////////////////////////////////////////////////////////
...
#ifdef l1Rate_my_cxx
l1Rate_my::l1Rate_my(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Tree_MinBias_PU200_modified.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Tree_MinBias_PU200_modified.root");
      }
      f->GetObject("t",tree);
...
Int_t l1Rate_my::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t l1Rate_my::LoadTree(Long64_t entry)
{
...
void l1Rate_my::Init(TTree *tree)
{
...
void l1Rate_my::Show(Long64_t entry)
{
...
Int_t l1Rate_my::Cut(Long64_t entry)
{
