...
void roofit_input::Loop()
{
   ...
   Bsl1_l1l2_points << "double gen_Pt[74] ={}, point[74] = {}, error[74] = {};" << endl;
   Bsl1_l1l2_points << "int points = 74;" << endl;
   ...
   for(Int_t nth = 2; nth < 4; nth++)
   {
       ...
       Bsl1_l1l2_points << "gen_Pt[" << count << "] = " << low_pt << "; point[" << count << "] = " << fabs(func->GetParameter(1)) << "; error[" << count << "] = " << fabs(func->GetParameter(2)) << ";" << endl;
   ...
   for(Int_t nth = 0; nth < 6; nth++)
   {
       ...
       sprintf(histname, "hist_%dth", count+1);
       H[count] = new TH1F(histname,"",250,-0.04,0.02);
