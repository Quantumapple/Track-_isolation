...
// Wed May 30 18:01:47 2018 by ROOT version 6.12/06
// from TTree t/t
// found on file: Tree_SE_PU140.root
//////////////////////////////////////////////////////////
...
#ifdef signa_cxx
signa::signa(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Tree_SE_PU140.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Tree_SE_PU140.root");
      }
      f->GetObject("t",tree);
...
Int_t signa::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t signa::LoadTree(Long64_t entry)
{
...
void signa::Show(Long64_t entry)
{
...
Int_t signa::Cut(Long64_t entry)
{
